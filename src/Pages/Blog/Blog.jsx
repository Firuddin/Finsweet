  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center ">
        <h4 className="font-bold text-pirmary text-5xl mt-10 mb-5">Read our latest blogs</h4>
      ...
      <div className="flex items-center justify-center border border-solid rounded-3xl pt-10 pb-10 gap-60 ml-20 mr-20">
        <div>
          <h3 className="text-pink font-bold text-4xl mb-4">Trending Post</h3>
          <h3 className="font-bold text-pirmary text-3xl mb-4">New invoicing features to <br /> help you get paid faster</h3>
      ...
      <div className="mt-20 mb-10">
        <h3 className="flex items-center justify-center text-pirmary font-bold text-5xl">All posts</h3>
      </div>
